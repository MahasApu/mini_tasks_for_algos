...
# следовательно алгоритм пройдет по n-m+1 цифрам делимого. Также необходимо циклом while найти такое число С*m (целая часть от деления) (C от 1 до 10), чтобы при умножении него на делитель
